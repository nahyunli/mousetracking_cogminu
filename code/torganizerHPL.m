...
%             eptray(epc,1)=str2num(tmtray.subject_nr{1}); %subject number            
            ...
            %x 좌표
            xPre = split(tmtray.xpos_get_response_bef(rIDX(rr)),["[","]",", "]);
            xPre=str2double(xPre(2:end-1));
            
            xPos = split(tmtray.xpos_get_response_pos(rIDX(rr)),["[","]",", "]);
            xPos=str2double(xPos(2:end-1));
...
%             subplot(1,3,1);
%             plot(xPre, yPre);xlim([0 15]);ylim([-400 0]); title('Pre');           
%             subplot(1,3,2);
%             plot(xPos, yPos);xlim([0 15]);ylim([-400 0]);title('Pos');
%             subplot(1,3,3);
%             plot(nX, nY);xlim([0 15]);ylim([-400 0]);title('Merged');
%             %SEMINAR DEMO!!!!!!!!!!!!!!
...
%             figure('units','normalized','outerposition',[0 0 1 1])
%             subplot(1,2,1);
%             plot(ooX, ooY,'-o');title('Before resampling');%xlim([0 15]);ylim([-400 0]);
%             subplot(1,2,2);
%             plot(nX, nY,'-o');title('After resampling');%xlim([0 15]);ylim([-400 0]);
%             %SEMINAR DEMO!!!!!!!!!!!!!!            
...
%                 figure('units','normalized','outerposition',[0 0 1 1])
%                 subplot(1,3,1);
%                 plot(ooX, ooY,'-o');title('Before rotation');xlim([-400 400]);ylim([-400 400]);
%                 hold on 
%                 vline(0,'--k');hline(0,'--k');                
%                 subplot(1,3,2);
%                 plot(ooX2, ooY2,'-o');title('After flipping vertically');xlim([-400 400]);ylim([-400 400]);  
%                 hold on 
%                 vline(0,'--k');hline(0,'--k');                
%                 subplot(1,3,3);
%                 plot(ooX3, ooY3,'-o');title('After rotating 90 deg');xlim([-400 400]);ylim([-400 400]);      
%                 hold on 
%                 vline(0,'--k');hline(0,'--k');                
%                 %Seminar Demo!!!!!!                
